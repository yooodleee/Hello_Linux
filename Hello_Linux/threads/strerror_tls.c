/*
	An implementation of strerror() that is made thread-safe through the use of thread-local storage.

	Thread-local storage requires: Linux 2.6 or later, NPTL, and gcc 3.3 or later.
*/
